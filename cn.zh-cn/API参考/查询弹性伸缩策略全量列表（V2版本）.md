...
GET /autoscaling-api/v2/\{project\_id\}/scaling\_policy\{?scaling\_resource\_id,scaling\_resource\_type ,scaling\_policy\_name,scaling\_policy\_id,scaling\_policy\_type,start\_number,limit,sort\_by,order,enterprise\_project\_id\}
...
<table><thead align="left"><tr id="row1599716379557"><th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.1"><p id="p194591157135519"><a name="p194591157135519"></a><a name="p194591157135519"></a>名称</p>
</th>
...
<th class="cellrowborder" valign="top" width="19%" id="mcps1.2.5.1.3"><p id="p17459185713552"><a name="p17459185713552"></a><a name="p17459185713552"></a>参数类型</p>
</th>
<th class="cellrowborder" valign="top" width="39%" id="mcps1.2.5.1.4"><p id="p20459657135519"><a name="p20459657135519"></a><a name="p20459657135519"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p184591576554"><a name="p184591576554"></a><a name="p184591576554"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p134595571556"><a name="p134595571556"></a><a name="p134595571556"></a>项目ID</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p3459155795513"><a name="p3459155795513"></a><a name="p3459155795513"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p11459145715510"><a name="p11459145715510"></a><a name="p11459145715510"></a>伸缩资源ID</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p1745915577553"><a name="p1745915577553"></a><a name="p1745915577553"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p3459957135511"><a name="p3459957135511"></a><a name="p3459957135511"></a>伸缩资源类型</p>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p8459175735514"><a name="p8459175735514"></a><a name="p8459175735514"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p12459175711559"><a name="p12459175711559"></a><a name="p12459175711559"></a>伸缩策略名称</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p0459557105511"><a name="p0459557105511"></a><a name="p0459557105511"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p345985710553"><a name="p345985710553"></a><a name="p345985710553"></a>伸缩策略ID</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p1845917576551"><a name="p1845917576551"></a><a name="p1845917576551"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p194591757185519"><a name="p194591757185519"></a><a name="p194591757185519"></a>策略类型。</p>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p3460757165513"><a name="p3460757165513"></a><a name="p3460757165513"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p164600570552"><a name="p164600570552"></a><a name="p164600570552"></a>查询的起始行号，默认为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p446045711550"><a name="p446045711550"></a><a name="p446045711550"></a>Integer</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p1346015573557"><a name="p1346015573557"></a><a name="p1346015573557"></a>查询记录数，默认20，最大100。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p146055785510"><a name="p146055785510"></a><a name="p146055785510"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p11460557195514"><a name="p11460557195514"></a><a name="p11460557195514"></a>排序方法</p>
<p id="p54601657135515"><a name="p54601657135515"></a><a name="p54601657135515"></a>POLICY_NAME：根据策略名称排序，</p>
<p id="p1346010576554"><a name="p1346010576554"></a><a name="p1346010576554"></a>TRIGGER_CONDITION：根据触发条件排序，如升序下，告警策略最先，其余根据最近一次触发时间升序排列，</p>
<p id="p24601357205512"><a name="p24601357205512"></a><a name="p24601357205512"></a>CREATE_TIME：根据策略的创建时间排序</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p1846045755513"><a name="p1846045755513"></a><a name="p1846045755513"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p194604578557"><a name="p194604578557"></a><a name="p194604578557"></a>排序顺序</p>
<p id="p5460205795519"><a name="p5460205795519"></a><a name="p5460205795519"></a>ASC：升序</p>
<p id="p16460165712552"><a name="p16460165712552"></a><a name="p16460165712552"></a>DESC：降序</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="19%" headers="mcps1.2.5.1.3 "><p id="p15461457125512"><a name="p15461457125512"></a><a name="p15461457125512"></a>String</p>
</td>
<td class="cellrowborder" valign="top" width="39%" headers="mcps1.2.5.1.4 "><p id="p1246119573557"><a name="p1246119573557"></a><a name="p1246119573557"></a>企业项目ID，当传入all_granted_eps时表示查询该用户所有授权的企业项目下的伸缩组列表。</p>
</td>
</tr>
</tbody>
</table>
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <table><thead align="left"><tr id="row16792317182"><th class="cellrowborder" valign="top" width="24.362436243624362%" id="mcps1.2.4.1.1"><p id="p11677233185"><a name="p11677233185"></a><a name="p11677233185"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51.995199519951996%" id="mcps1.2.4.1.3"><p id="p467123161819"><a name="p467123161819"></a><a name="p467123161819"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="23.642364236423642%" headers="mcps1.2.4.1.2 "><p id="p867152313180"><a name="p867152313180"></a><a name="p867152313180"></a>列表数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.995199519951996%" headers="mcps1.2.4.1.3 "><p id="p9671523171818"><a name="p9671523171818"></a><a name="p9671523171818"></a>伸缩策略列表</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  scaling\_policies字段数据结构说明
    ...
    <table><thead align="left"><tr id="row9776134561813"><th class="cellrowborder" valign="top" width="24.48%" id="mcps1.2.4.1.1"><p id="p2776164561819"><a name="p2776164561819"></a><a name="p2776164561819"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="52.61%" id="mcps1.2.4.1.3"><p id="p4776124513183"><a name="p4776124513183"></a><a name="p4776124513183"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.2.4.1.2 "><p id="p2777164514182"><a name="p2777164514182"></a><a name="p2777164514182"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.61%" headers="mcps1.2.4.1.3 "><p id="p1377784521818"><a name="p1377784521818"></a><a name="p1377784521818"></a>定时、周期任务策</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.2.4.1.2 "><p id="p19777645131815"><a name="p19777645131815"></a><a name="p19777645131815"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.61%" headers="mcps1.2.4.1.3 "><p id="p187778457184"><a name="p187778457184"></a><a name="p187778457184"></a>策略执行具体动作</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="22.91%" headers="mcps1.2.4.1.2 "><p id="p9137491810"><a name="p9137491810"></a><a name="p9137491810"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.61%" headers="mcps1.2.4.1.3 "><p id="p1137498119"><a name="p1137498119"></a><a name="p1137498119"></a>附加信息。</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 4**  scheduled\_policy字段数据结构说明
    ...
    <table><thead align="left"><tr id="row10872131111198"><th class="cellrowborder" valign="top" width="24.85%" id="mcps1.2.4.1.1"><p id="p18725111193"><a name="p18725111193"></a><a name="p18725111193"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="52.65%" id="mcps1.2.4.1.3"><p id="p16872611141910"><a name="p16872611141910"></a><a name="p16872611141910"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    **表 5**  scaling\_policy\_action字段数据结构说明
    ...
    <table><thead align="left"><tr id="row12867203681919"><th class="cellrowborder" valign="top" width="24.73%" id="mcps1.2.4.1.1"><p id="p9867153619195"><a name="p9867153619195"></a><a name="p9867153619195"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51.74999999999999%" id="mcps1.2.4.1.3"><p id="p4867436161920"><a name="p4867436161920"></a><a name="p4867436161920"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    **表 6**  meta\_data字段数据结构说明
    ...
    <table><thead align="left"><tr id="row1337012281628"><th class="cellrowborder" valign="top" width="24.73%" id="mcps1.2.4.1.1"><p id="p1137082817211"><a name="p1137082817211"></a><a name="p1137082817211"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51.160000000000004%" id="mcps1.2.4.1.3"><p id="p1937012280210"><a name="p1937012280210"></a><a name="p1937012280210"></a>说明</p>
    </th>
    </tr>
    </thead>
