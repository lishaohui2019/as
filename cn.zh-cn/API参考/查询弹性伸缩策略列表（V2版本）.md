...
-   响应参数
    ...
    **表 3**  scaling\_policies字段数据结构说明
    ...
    <td class="cellrowborder" valign="top" width="50.495049504950494%" headers="mcps1.2.4.1.3 "><p id="p1377784521818"><a name="p1377784521818"></a><a name="p1377784521818"></a>定时、周期任务策略。</p>
    </td>
    </tr>
