...
<table><thead align="left"><tr id="row460813297221"><th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.1"><p id="p56081829132215"><a name="p56081829132215"></a><a name="p56081829132215"></a>名称</p>
</th>
...
<th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.4"><p id="p1460832962213"><a name="p1460832962213"></a><a name="p1460832962213"></a>说明</p>
</th>
</tr>
</thead>
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <table><thead align="left"><tr id="row1568568220"><th class="cellrowborder" valign="top" width="21.43%" id="mcps1.2.4.1.1"><p id="p7795617226"><a name="p7795617226"></a><a name="p7795617226"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="52.04%" id="mcps1.2.4.1.3"><p id="p127115632214"><a name="p127115632214"></a><a name="p127115632214"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="26.529999999999998%" headers="mcps1.2.4.1.2 "><p id="p16715662217"><a name="p16715662217"></a><a name="p16715662217"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="52.04%" headers="mcps1.2.4.1.3 "><p id="p671556172214"><a name="p671556172214"></a><a name="p671556172214"></a>伸缩策略详情</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 3**  scaling\_policy字段数据结构说明
    ...
    <table><thead align="left"><tr id="row971956152212"><th class="cellrowborder" valign="top" width="21.782178217821784%" id="mcps1.2.4.1.1"><p id="p5785612215"><a name="p5785612215"></a><a name="p5785612215"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51.48514851485149%" id="mcps1.2.4.1.3"><p id="p1277568221"><a name="p1277568221"></a><a name="p1277568221"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <a name="ul6912561227"></a><a name="ul6912561227"></a><ul id="ul6912561227"><li>INSERVICE：使用中</li><li>PAUSED：停止</li><li>EXECUTING：执行中</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="26.732673267326735%" headers="mcps1.2.4.1.2 "><p id="p139056142216"><a name="p139056142216"></a><a name="p139056142216"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.48514851485149%" headers="mcps1.2.4.1.3 "><p id="p1891456122210"><a name="p1891456122210"></a><a name="p1891456122210"></a>定时、周期任务策略。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="26.732673267326735%" headers="mcps1.2.4.1.2 "><p id="p14945622213"><a name="p14945622213"></a><a name="p14945622213"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.48514851485149%" headers="mcps1.2.4.1.3 "><p id="p1710155610222"><a name="p1710155610222"></a><a name="p1710155610222"></a>策略执行具体动作</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="26.732673267326735%" headers="mcps1.2.4.1.2 "><p id="p37523971175834"><a name="p37523971175834"></a><a name="p37523971175834"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.48514851485149%" headers="mcps1.2.4.1.3 "><p id="p41667816175834"><a name="p41667816175834"></a><a name="p41667816175834"></a>附加信息</p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    **表 4**  scheduled\_policy字段数据结构说明
    ...
    <table><thead align="left"><tr id="row511155632217"><th class="cellrowborder" valign="top" width="22.222222222222225%" id="mcps1.2.4.1.1"><p id="p511556192217"><a name="p511556192217"></a><a name="p511556192217"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="26.262626262626267%" id="mcps1.2.4.1.2"><p id="p181195611223"><a name="p181195611223"></a><a name="p181195611223"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="51.515151515151516%" id="mcps1.2.4.1.3"><p id="p811195610228"><a name="p811195610228"></a><a name="p811195610228"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="26.262626262626267%" headers="mcps1.2.4.1.2 "><p id="p16111756162215"><a name="p16111756162215"></a><a name="p16111756162215"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.515151515151516%" headers="mcps1.2.4.1.3 "><p id="p191175610221"><a name="p191175610221"></a><a name="p191175610221"></a>触发时间，遵循UTC时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="26.262626262626267%" headers="mcps1.2.4.1.2 "><p id="p1611205612226"><a name="p1611205612226"></a><a name="p1611205612226"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.515151515151516%" headers="mcps1.2.4.1.3 "><p id="p0110564224"><a name="p0110564224"></a><a name="p0110564224"></a>周期触发类型。</p>
    <p id="p201135692219"><a name="p201135692219"></a><a name="p201135692219"></a>Daily：每天执行一次</p>
    <p id="p911856192213"><a name="p911856192213"></a><a name="p911856192213"></a>Weekly：每周指定天执行一次。</p>
    <p id="p414145611228"><a name="p414145611228"></a><a name="p414145611228"></a>Monthly：每月指定天执行一次。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="26.262626262626267%" headers="mcps1.2.4.1.2 "><p id="p2014125632212"><a name="p2014125632212"></a><a name="p2014125632212"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.515151515151516%" headers="mcps1.2.4.1.3 "><p id="p2014956162216"><a name="p2014956162216"></a><a name="p2014956162216"></a>周期触发任务数值：</p>
    ...
    <td class="cellrowborder" valign="top" width="26.262626262626267%" headers="mcps1.2.4.1.2 "><p id="p61485682213"><a name="p61485682213"></a><a name="p61485682213"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.515151515151516%" headers="mcps1.2.4.1.3 "><p id="p215135612216"><a name="p215135612216"></a><a name="p215135612216"></a>周期策略重复执行开始时间，遵循UTC时间。</p>
    ...
    <td class="cellrowborder" valign="top" width="26.262626262626267%" headers="mcps1.2.4.1.2 "><p id="p215145642216"><a name="p215145642216"></a><a name="p215145642216"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="51.515151515151516%" headers="mcps1.2.4.1.3 "><p id="p13151056112217"><a name="p13151056112217"></a><a name="p13151056112217"></a>周期策略重复执行结束时间，遵循UTC时间。</p>
    ...
    **表 5**  scaling\_policy\_action字段数据结构说明
    ...
    <table><thead align="left"><tr id="row1115556162215"><th class="cellrowborder" valign="top" width="23%" id="mcps1.2.4.1.1"><p id="p915105622213"><a name="p915105622213"></a><a name="p915105622213"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51%" id="mcps1.2.4.1.3"><p id="p415356112219"><a name="p415356112219"></a><a name="p415356112219"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <p id="p52314560229"><a name="p52314560229"></a><a name="p52314560229"></a>ADD：减少</p>
    <p id="p1823185618229"><a name="p1823185618229"></a><a name="p1823185618229"></a>REDUCE：增加</p>
    <p id="p1023125617227"><a name="p1023125617227"></a><a name="p1023125617227"></a>SET：设置为</p>
    </td>
    </tr>
    ...
    **表 6**  meta\_data字段数据结构说明
    ...
    <table><thead align="left"><tr id="row25036975175854"><th class="cellrowborder" valign="top" width="23.762376237623762%" id="mcps1.2.4.1.1"><p id="p4598303175854"><a name="p4598303175854"></a><a name="p4598303175854"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51.48514851485149%" id="mcps1.2.4.1.3"><p id="p37591800175854"><a name="p37591800175854"></a><a name="p37591800175854"></a>说明</p>
    </th>
    </tr>
    </thead>
