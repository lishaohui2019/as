...
<table><thead align="left"><tr id="row13696163774311"><th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.1"><p id="p1279614712431"><a name="p1279614712431"></a><a name="p1279614712431"></a>名称</p>
</th>
...
<th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.4"><p id="p9796647104314"><a name="p9796647104314"></a><a name="p9796647104314"></a>说明</p>
</th>
</tr>
</thead>
...
-   请求参数
    ...
    **表 2**  请求参数
    ...
    <table><thead align="left"><tr id="row12020125459"><th class="cellrowborder" valign="top" width="21%" id="mcps1.2.5.1.1"><p id="p17592192817454"><a name="p17592192817454"></a><a name="p17592192817454"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="50%" id="mcps1.2.5.1.4"><p id="p559214289456"><a name="p559214289456"></a><a name="p559214289456"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="p559262834520"><a name="p559262834520"></a><a name="p559262834520"></a>策略名称（1-64字符），可以用中文、字母、数字、下划线、中划线的组合。</p>
    </td>
    </tr>
    ...
    <a name="ul712911394401"></a><a name="ul712911394401"></a><ul id="ul712911394401"><li>如果scaling_resource_type为SCALING_GROUP，对应伸缩组唯一标识</li><li>如果scaling_resource_type为BANDWIDTH，对应带宽唯一标识</li></ul>
    </td>
    </tr>
    ...
    <p id="p18594112815454"><a name="p18594112815454"></a><a name="p18594112815454"></a>告警ID通过查询云监控告警规则列表获取，详见《云监控API参考》的“查询告警规则列表”。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p1459472815451"><a name="p1459472815451"></a><a name="p1459472815451"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="p1859414287454"><a name="p1859414287454"></a><a name="p1859414287454"></a>定时、周期任务策略，当scaling_policy_type为SCHEDULED或RECURRENCE时该项必选，此时alarm_id不生效。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p359442854518"><a name="p359442854518"></a><a name="p359442854518"></a>字典数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p id="p12594528104514"><a name="p12594528104514"></a><a name="p12594528104514"></a>策略执行具体动作。</p>
    </td>
    </tr>
    ...
    **表 3**  scheduled\_policy字段数据结构说明
    ...
    <table><thead align="left"><tr id="row04247128463"><th class="cellrowborder" valign="top" width="21.21212121212121%" id="mcps1.2.5.1.1"><p id="p1436872914616"><a name="p1436872914616"></a><a name="p1436872914616"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="49.494949494949495%" id="mcps1.2.5.1.4"><p id="p10368229174610"><a name="p10368229174610"></a><a name="p10368229174610"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <p id="p20368142917466"><a name="p20368142917466"></a><a name="p20368142917466"></a>Daily：每天执行一次</p>
    <p id="p1236892974613"><a name="p1236892974613"></a><a name="p1236892974613"></a>Weekly：每周指定天执行一次。</p>
    <p id="p4368122918466"><a name="p4368122918466"></a><a name="p4368122918466"></a>Monthly：每月指定天执行一次。</p>
    </td>
    </tr>
    ...
    **表 4**  scaling\_policy\_action字段数据结构说明
    ...
    <table><thead align="left"><tr id="row914933174911"><th class="cellrowborder" valign="top" width="21%" id="mcps1.2.5.1.1"><p id="p1984914718496"><a name="p1984914718496"></a><a name="p1984914718496"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="14.000000000000002%" id="mcps1.2.5.1.2"><p id="p68491047104920"><a name="p68491047104920"></a><a name="p68491047104920"></a>是否必选</p>
    </th>
    <th class="cellrowborder" valign="top" width="16%" id="mcps1.2.5.1.3"><p id="p12849747144916"><a name="p12849747144916"></a><a name="p12849747144916"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="49%" id="mcps1.2.5.1.4"><p id="p98494475496"><a name="p98494475496"></a><a name="p98494475496"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.5.1.2 "><p id="p12849647124917"><a name="p12849647124917"></a><a name="p12849647124917"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p19849164719493"><a name="p19849164719493"></a><a name="p19849164719493"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.2.5.1.4 "><p id="p12849194711498"><a name="p12849194711498"></a><a name="p12849194711498"></a>操作选项，默认为ADD。</p>
    <p id="p684914713498"><a name="p684914713498"></a><a name="p684914713498"></a>ADD：添加</p>
    <p id="p1784914717497"><a name="p1784914717497"></a><a name="p1784914717497"></a>REDUCE：减少</p>
    <p id="p188491547124914"><a name="p188491547124914"></a><a name="p188491547124914"></a>SET：设置为</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.5.1.2 "><p id="p208491947124912"><a name="p208491947124912"></a><a name="p208491947124912"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p5849247124914"><a name="p5849247124914"></a><a name="p5849247124914"></a>Integer</p>
    </td>
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.2.5.1.4 "><p id="p18849194784912"><a name="p18849194784912"></a><a name="p18849194784912"></a>操作大小，取值范围为0到300的整数，默认为1。操作为ADD或REDUCE时取值不能为0。</p>
    <p id="p48492477499"><a name="p48492477499"></a><a name="p48492477499"></a>当scaling_resource_type为SCALING_GROUP时，size为实例个数，取值范围为0到300的整数，默认为1。</p>
    <p id="p188491447144919"><a name="p188491447144919"></a><a name="p188491447144919"></a>当scaling_resource_type为BANDWIDTH时，size表示带宽大小，单位为Mbit/s，取值范围为1到300的整数，默认为1。</p>
    ...
    <td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.5.1.2 "><p id="p785044715492"><a name="p785044715492"></a><a name="p785044715492"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p178501847124913"><a name="p178501847124913"></a><a name="p178501847124913"></a>Integer</p>
    </td>
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.2.5.1.4 "><p id="p38501247184913"><a name="p38501247184913"></a><a name="p38501247184913"></a>操作百分比，操作为ADD或REDUCE时取值范围为1到20000的整数，操作为SET时取值范围为0到20000的整数。</p>
    <p id="p1185014714491"><a name="p1185014714491"></a><a name="p1185014714491"></a>当scaling_resource_type为SCALING_GROUP时，size和percentage参数只能选其中一个进行配置，如果size和instance_percentage参数均无配置，则size默认为1。</p>
    ...
    <td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.2.5.1.2 "><p id="p4850547184915"><a name="p4850547184915"></a><a name="p4850547184915"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16%" headers="mcps1.2.5.1.3 "><p id="p385004711497"><a name="p385004711497"></a><a name="p385004711497"></a>Integer</p>
    </td>
    <td class="cellrowborder" valign="top" width="49%" headers="mcps1.2.5.1.4 "><p id="p11850647164919"><a name="p11850647164919"></a><a name="p11850647164919"></a>操作限制</p>
    ...
    <p id="p98501647184920"><a name="p98501647184920"></a><a name="p98501647184920"></a>当operation为ADD时，limits表示带宽可调整的上限；</p>
    <p id="p0850647194910"><a name="p0850647194910"></a><a name="p0850647194910"></a>当operation为REDUCE时，limits表示带宽可调整的下限。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   响应参数
    ...
    **表 5**  响应参数
    ...
    <table><thead align="left"><tr id="row134541952105817"><th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.1"><p id="p14813106591"><a name="p14813106591"></a><a name="p14813106591"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="33.33333333333333%" id="mcps1.2.4.1.3"><p id="p1681360205913"><a name="p1681360205913"></a><a name="p1681360205913"></a>说明</p>
    </th>
    </tr>
    </thead>
