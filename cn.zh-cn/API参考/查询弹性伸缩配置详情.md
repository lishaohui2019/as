...
<table><thead align="left"><tr id="row38709481"><th class="cellrowborder" valign="top" width="32.14%" id="mcps1.2.5.1.1"><p id="p48460267"><a name="p48460267"></a><a name="p48460267"></a>名称</p>
</th>
...
<th class="cellrowborder" valign="top" width="25%" id="mcps1.2.5.1.4"><p id="p8413469"><a name="p8413469"></a><a name="p8413469"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="25%" headers="mcps1.2.5.1.4 "><p id="p43678569"><a name="p43678569"></a><a name="p43678569"></a>伸缩配置ID，查询唯一配置。</p>
</td>
</tr>
</tbody>
</table>
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <table><thead align="left"><tr id="row58067579"><th class="cellrowborder" valign="top" width="30.330000000000002%" id="mcps1.2.4.1.1"><p id="p5853458"><a name="p5853458"></a><a name="p5853458"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="36.34%" id="mcps1.2.4.1.2"><p id="p4368081"><a name="p4368081"></a><a name="p4368081"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="33.33%" id="mcps1.2.4.1.3"><p id="p18270305"><a name="p18270305"></a><a name="p18270305"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="36.34%" headers="mcps1.2.4.1.2 "><p id="p10655236"><a name="p10655236"></a><a name="p10655236"></a>字典数据结构</p>
    </td>
    ...
    **表 3**  scaling\_configurations字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_re3411f14be354adaa992fb18acd266b3"><th class="cellrowborder" valign="top" width="28.24%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_ae52f2b98f7ec4b6d9ae5abe16d2066e6"><a name="zh-cn_topic_0043063056_ae52f2b98f7ec4b6d9ae5abe16d2066e6"></a><a name="zh-cn_topic_0043063056_ae52f2b98f7ec4b6d9ae5abe16d2066e6"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="47.760000000000005%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_a5326130b389b42b9a93032b05b03722a"><a name="zh-cn_topic_0043063056_a5326130b389b42b9a93032b05b03722a"></a><a name="zh-cn_topic_0043063056_a5326130b389b42b9a93032b05b03722a"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="24%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_a4c03d226ca78442f99e13b8d363cd51d"><a name="zh-cn_topic_0043063056_a4c03d226ca78442f99e13b8d363cd51d"></a><a name="zh-cn_topic_0043063056_a4c03d226ca78442f99e13b8d363cd51d"></a>字典数据结构</p>
    </td>
    ...
    **表 4**  instance\_config字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_r4c26d84153be4464b22847e9b6182390"><th class="cellrowborder" valign="top" width="27.450000000000003%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_ae87dd78bead34b4bb60b8b3f402c44f2"><a name="zh-cn_topic_0043063056_ae87dd78bead34b4bb60b8b3f402c44f2"></a><a name="zh-cn_topic_0043063056_ae87dd78bead34b4bb60b8b3f402c44f2"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="47.93%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_a797f28c561484893b5f5cfc317582ba5"><a name="zh-cn_topic_0043063056_a797f28c561484893b5f5cfc317582ba5"></a><a name="zh-cn_topic_0043063056_a797f28c561484893b5f5cfc317582ba5"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="24.62%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_a59f1976b777c49dabc9f22e498393078"><a name="zh-cn_topic_0043063056_a59f1976b777c49dabc9f22e498393078"></a><a name="zh-cn_topic_0043063056_a59f1976b777c49dabc9f22e498393078"></a>列表数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="24.62%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_af0a4b1b96a534569986e2f66b4c3a81f"><a name="zh-cn_topic_0043063056_af0a4b1b96a534569986e2f66b4c3a81f"></a><a name="zh-cn_topic_0043063056_af0a4b1b96a534569986e2f66b4c3a81f"></a>列表数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="24.62%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_p65398812105253"><a name="zh-cn_topic_0043063056_p65398812105253"></a><a name="zh-cn_topic_0043063056_p65398812105253"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="24.62%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_p2946673210057"><a name="zh-cn_topic_0043063056_p2946673210057"></a><a name="zh-cn_topic_0043063056_p2946673210057"></a>字典数据结构</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="24.62%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_p10265121214315"><a name="zh-cn_topic_0043063056_p10265121214315"></a><a name="zh-cn_topic_0043063056_p10265121214315"></a>列表数据结构</p>
    </td>
    ...
    **表 5**  disk字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_row85230949436"><th class="cellrowborder" valign="top" width="27.507249275072493%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_p192820059436"><a name="zh-cn_topic_0043063056_p192820059436"></a><a name="zh-cn_topic_0043063056_p192820059436"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="47.615238476152385%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_p90314069436"><a name="zh-cn_topic_0043063056_p90314069436"></a><a name="zh-cn_topic_0043063056_p90314069436"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    **表 6**  personality字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_row2268379894321"><th class="cellrowborder" valign="top" width="27.32%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_p2544835194321"><a name="zh-cn_topic_0043063056_p2544835194321"></a><a name="zh-cn_topic_0043063056_p2544835194321"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="47.24%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_p6689220494321"><a name="zh-cn_topic_0043063056_p6689220494321"></a><a name="zh-cn_topic_0043063056_p6689220494321"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    **表 7**  public\_ip字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_rf04af88fbbdf4ecba6a3e6e9aad079f9"><th class="cellrowborder" valign="top" width="28.12281228122812%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_afd8569082e55402cba696b519061600b"><a name="zh-cn_topic_0043063056_afd8569082e55402cba696b519061600b"></a><a name="zh-cn_topic_0043063056_afd8569082e55402cba696b519061600b"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="47.02470247024703%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_zh-cn_topic_0020845949_p851285010312"><a name="zh-cn_topic_0043063056_zh-cn_topic_0020845949_p851285010312"></a><a name="zh-cn_topic_0043063056_zh-cn_topic_0020845949_p851285010312"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="24.852485248524854%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_a28c26bf5d6c54593a719314634686624"><a name="zh-cn_topic_0043063056_a28c26bf5d6c54593a719314634686624"></a><a name="zh-cn_topic_0043063056_a28c26bf5d6c54593a719314634686624"></a>字典数据结构</p>
    </td>
    ...
    **表 8**  eip字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_r87ed6857ffae47088b1500be4cc20349"><th class="cellrowborder" valign="top" width="24.060000000000002%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_ad86da605a6b94513b3155b6e54b5083f"><a name="zh-cn_topic_0043063056_ad86da605a6b94513b3155b6e54b5083f"></a><a name="zh-cn_topic_0043063056_ad86da605a6b94513b3155b6e54b5083f"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="51.32%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_a9baeb04a7c2f4c9c852c1e5874dbbffd"><a name="zh-cn_topic_0043063056_a9baeb04a7c2f4c9c852c1e5874dbbffd"></a><a name="zh-cn_topic_0043063056_a9baeb04a7c2f4c9c852c1e5874dbbffd"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="24.62%" headers="mcps1.2.4.1.2 "><p id="zh-cn_topic_0043063056_aae244f35057c4f2495a98ece91ed5eb6"><a name="zh-cn_topic_0043063056_aae244f35057c4f2495a98ece91ed5eb6"></a><a name="zh-cn_topic_0043063056_aae244f35057c4f2495a98ece91ed5eb6"></a>字典数据结构</p>
    </td>
    ...
    **表 9**  bandwidth字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_r423eaa8930174f0ba29e71993bff93da"><th class="cellrowborder" valign="top" width="28.12%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_a4232ce3904fd45eaa61c236eff6ebf85"><a name="zh-cn_topic_0043063056_a4232ce3904fd45eaa61c236eff6ebf85"></a><a name="zh-cn_topic_0043063056_a4232ce3904fd45eaa61c236eff6ebf85"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="46.550000000000004%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_a7c976ed70ac74bf0a8eac92204ccedcf"><a name="zh-cn_topic_0043063056_a7c976ed70ac74bf0a8eac92204ccedcf"></a><a name="zh-cn_topic_0043063056_a7c976ed70ac74bf0a8eac92204ccedcf"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <p id="zh-cn_topic_0043063056_zh-cn_topic_0020845949_p226836615358"><a name="zh-cn_topic_0043063056_zh-cn_topic_0020845949_p226836615358"></a><a name="zh-cn_topic_0043063056_zh-cn_topic_0020845949_p226836615358"></a>PER，表示独享。WHOLE，表示共享。</p>
    </td>
    </tr>
    ...
    <a name="zh-cn_topic_0043063056_u7a851e86e06a442c942f1c43a416b218"></a><a name="zh-cn_topic_0043063056_u7a851e86e06a442c942f1c43a416b218"></a><ul id="zh-cn_topic_0043063056_u7a851e86e06a442c942f1c43a416b218"><li>字段值为“bandwidth”，表示按带宽计费。</li><li>字段值为“traffic”，表示按流量计费。</li></ul>
    </td>
    </tr>
    ...
    **表 10**  metadata字段数据结构说明
    ...
    <table><thead align="left"><tr id="zh-cn_topic_0043063056_row5794517795435"><th class="cellrowborder" valign="top" width="28.24282428242824%" id="mcps1.2.4.1.1"><p id="zh-cn_topic_0043063056_p6304778595435"><a name="zh-cn_topic_0043063056_p6304778595435"></a><a name="zh-cn_topic_0043063056_p6304778595435"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="46.2946294629463%" id="mcps1.2.4.1.3"><p id="zh-cn_topic_0043063056_p6466497295435"><a name="zh-cn_topic_0043063056_p6466497295435"></a><a name="zh-cn_topic_0043063056_p6466497295435"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    **表 11**  security\_groups字段数据结构说明
    ...
    <table><thead align="left"><tr id="row21632216254"><th class="cellrowborder" valign="top" width="24.242424242424242%" id="mcps1.2.4.1.1"><p id="p516332116258"><a name="p516332116258"></a><a name="p516332116258"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="49.494949494949495%" id="mcps1.2.4.1.3"><p id="p0163521152518"><a name="p0163521152518"></a><a name="p0163521152518"></a>说明</p>
    </th>
    </tr>
    </thead>
