...
GET /autoscaling-api/v1/\{project\_id\}/scaling\_group\{?scaling\_group\_name,scaling\_configuration\_id,scaling\_group\_status,start\_number,limit,enterprise\_project\_id\}
...
<table><thead align="left"><tr id="row58113810"><th class="cellrowborder" valign="top" width="27%" id="mcps1.2.5.1.1"><p id="p9598184"><a name="p9598184"></a><a name="p9598184"></a>名称</p>
</th>
...
<th class="cellrowborder" valign="top" width="43%" id="mcps1.2.5.1.4"><p id="p58276509"><a name="p58276509"></a><a name="p58276509"></a>说明</p>
</th>
</tr>
</thead>
...
<td class="cellrowborder" valign="top" width="43%" headers="mcps1.2.5.1.4 "><p id="p54017281"><a name="p54017281"></a><a name="p54017281"></a>伸缩配置ID，通过查询弹性伸缩配置列表接口获取，详见<a href="查询弹性伸缩配置列表.md">查询弹性伸缩配置列表</a>。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="43%" headers="mcps1.2.5.1.4 "><p id="p48819313"><a name="p48819313"></a><a name="p48819313"></a>伸缩组状态，包括INSERVICE，PAUSED，ERROR，DELETING、FREEZED。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="43%" headers="mcps1.2.5.1.4 "><p id="p59373825"><a name="p59373825"></a><a name="p59373825"></a>查询的起始行号，默认为0。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="43%" headers="mcps1.2.5.1.4 "><p id="p21968676"><a name="p21968676"></a><a name="p21968676"></a>查询的记录条数，默认为20。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="43%" headers="mcps1.2.5.1.4 "><p id="p16973411164714"><a name="p16973411164714"></a><a name="p16973411164714"></a>企业项目ID，当传入all_granted_eps时表示查询该用户所有授权的企业项目下的伸缩组列表。</p>
</td>
</tr>
</tbody>
</table>
...
-   响应参数
    ...
    **表 2**  响应参数
    ...
    <table><thead align="left"><tr id="row5521893"><th class="cellrowborder" valign="top" width="29.2%" id="mcps1.2.4.1.1"><p id="p44620187"><a name="p44620187"></a><a name="p44620187"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="39.35%" id="mcps1.2.4.1.3"><p id="p24182971"><a name="p24182971"></a><a name="p24182971"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <td class="cellrowborder" valign="top" width="31.45%" headers="mcps1.2.4.1.2 "><p id="p48517563"><a name="p48517563"></a><a name="p48517563"></a>列表数据结构</p>
    </td>
    ...
    **表 3**  scaling\_groups字段数据结构说明
    ...
    <table><thead align="left"><tr id="row3125168495816"><th class="cellrowborder" valign="top" width="28.92%" id="mcps1.2.4.1.1"><p id="p4835851595816"><a name="p4835851595816"></a><a name="p4835851595816"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="41.15%" id="mcps1.2.4.1.3"><p id="p5662264395816"><a name="p5662264395816"></a><a name="p5662264395816"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    <tr id="row17580032174650"><td class="cellrowborder" valign="top" width="28.92%" headers="mcps1.2.4.1.1 "><p id="p14696497174650"><a name="p14696497174650"></a><a name="p14696497174650"></a>lbaas_listeners</p>
    </td>
    <td class="cellrowborder" valign="top" width="29.93%" headers="mcps1.2.4.1.2 "><p id="p49565610174650"><a name="p49565610174650"></a><a name="p49565610174650"></a>列表数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="41.15%" headers="mcps1.2.4.1.3 "><p id="p55391508174650"><a name="p55391508174650"></a><a name="p55391508174650"></a>该参数为预留字段。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.93%" headers="mcps1.2.4.1.2 "><p id="p25943212112250"><a name="p25943212112250"></a><a name="p25943212112250"></a>List&lt;String&gt;</p>
    </td>
    <td class="cellrowborder" valign="top" width="41.15%" headers="mcps1.2.4.1.3 "><p id="p21025459112250"><a name="p21025459112250"></a><a name="p21025459112250"></a>可用分区信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.93%" headers="mcps1.2.4.1.2 "><p id="p2869527695816"><a name="p2869527695816"></a><a name="p2869527695816"></a>列表数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="41.15%" headers="mcps1.2.4.1.3 "><p id="p4800004895816"><a name="p4800004895816"></a><a name="p4800004895816"></a>网络信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.93%" headers="mcps1.2.4.1.2 "><p id="p1197357695816"><a name="p1197357695816"></a><a name="p1197357695816"></a>列表数据结构</p>
    </td>
    <td class="cellrowborder" valign="top" width="41.15%" headers="mcps1.2.4.1.3 "><p id="p458485895816"><a name="p458485895816"></a><a name="p458485895816"></a>安全组信息。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="41.15%" headers="mcps1.2.4.1.3 "><p id="p3105690795816"><a name="p3105690795816"></a><a name="p3105690795816"></a>伸缩组详情。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="29.93%" headers="mcps1.2.4.1.2 "><p id="p3565131995816"><a name="p3565131995816"></a><a name="p3565131995816"></a>List&lt;String&gt;</p>
    </td>
    ...
    **表 4**  networks字段数据结构说明
    ...
    <table><thead align="left"><tr id="r38fbfd545d8b41ac9a165cb5b185293c"><th class="cellrowborder" valign="top" width="33.39%" id="mcps1.2.4.1.1"><p id="a25948832a6e540e4aeaf9201f17c6136"><a name="a25948832a6e540e4aeaf9201f17c6136"></a><a name="a25948832a6e540e4aeaf9201f17c6136"></a>名称</p>
    </th>
    ...
    <th class="cellrowborder" valign="top" width="38.47%" id="mcps1.2.4.1.3"><p id="abe4729b8fced431487d765209a10d998"><a name="abe4729b8fced431487d765209a10d998"></a><a name="abe4729b8fced431487d765209a10d998"></a>说明</p>
    </th>
    </tr>
    </thead>
    ...
    **表 5**  security\_groups字段数据结构说明
    ...
    <table><thead align="left"><tr id="r64cc323b13f2470cbd5cf20531f45aad"><th class="cellrowborder" valign="top" width="33.33%" id="mcps1.2.4.1.1"><p id="ab42ad58aefab4311ac0c2507984a8107"><a name="ab42ad58aefab4311ac0c2507984a8107"></a><a name="ab42ad58aefab4311ac0c2507984a8107"></a>名称</p>
    </th>
    <th class="cellrowborder" valign="top" width="28.26%" id="mcps1.2.4.1.2"><p id="abd02ac6bdeed4b159635817d455d3286"><a name="abd02ac6bdeed4b159635817d455d3286"></a><a name="abd02ac6bdeed4b159635817d455d3286"></a>参数类型</p>
    </th>
    <th class="cellrowborder" valign="top" width="38.41%" id="mcps1.2.4.1.3"><p id="a6dc84c25ec0244e2844321a8291a9981"><a name="a6dc84c25ec0244e2844321a8291a9981"></a><a name="a6dc84c25ec0244e2844321a8291a9981"></a>说明</p>
    </th>
    </tr>
    </thead>
    <tbody><tr id="r3650c2ffcd3d405496639de740222790"><td class="cellrowborder" valign="top" width="33.33%" headers="mcps1.2.4.1.1 "><p id="ae0d8aa75f726414f812781414bf4d87f"><a name="ae0d8aa75f726414f812781414bf4d87f"></a><a name="ae0d8aa75f726414f812781414bf4d87f"></a>id</p>
    </td>
    <td class="cellrowborder" valign="top" width="28.26%" headers="mcps1.2.4.1.2 "><p id="a0b213143b4754bf786bb0ed28229d86a"><a name="a0b213143b4754bf786bb0ed28229d86a"></a><a name="a0b213143b4754bf786bb0ed28229d86a"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="38.41%" headers="mcps1.2.4.1.3 "><p id="adc3054875e29415a8e5f0d3cccda9703"><a name="adc3054875e29415a8e5f0d3cccda9703"></a><a name="adc3054875e29415a8e5f0d3cccda9703"></a>安全组ID</p>
    </td>
    </tr>
    </tbody>
    </table>
